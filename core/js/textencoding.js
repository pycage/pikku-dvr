...
/* Module for decoding DVB encoded texts.
 */
...
const LATIN = [
    ...
    0x0138, 0x00e6, 0x0111, 0x00f0, 0x0127, 0x0131, 0x0133, 0x0140, 0x0142, 0x00f8, 0x0153, 0x00df, 0x00fe, 0x0167, 0x0148, 0x00ad  // F-
];
...
const ISO_8859_9 = [
    ...
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, // 8-
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, // 9-
    0x00a0, 0x00a1, 0x00a2, 0x00a3, 0x20ac, 0x00a5, 0x00a6, 0x00a7, 0x00a8, 0x00a9, 0x00d7, 0x00ab, 0x00ac, 0x00ad, 0x00ae, 0x00af, // A-
    ...
    0x00e0, 0x00e1, 0x00e2, 0x00e3, 0x00e4, 0x00e5, 0x00e6, 0x00e7, 0x00e8, 0x00e9, 0x00ea, 0x00eb, 0x00ec, 0x00ed, 0x00ed, 0x00ef, // E-
...
const CODE_PAGES = {
 ...
 exports.decode = function (buffer)
 {
    ...
    {
        // ISO 8859-X
        console.log("ISO 8859-" + buffer[2]);
        offset = 3;
    }
    else if (buffer[0] === 0x11)
    {
        // UCS-2
        return buffer.slice(1).toString("ucs-2");
    }
    ...
    {
        // UTF-8
        return buffer.slice(1).toString("utf-8");
    }
    else if (buffer[0] < 0x1f)
    {
        //console.log("table " + buffer[0]);
        offset = 1;
        table = CODE_PAGES[buffer[0]]; // || TABLE_00;
    }
    else if (buffer[0] === 0x1f)
    {
        // TS 101 162 encoding_type_id; not supported right now
        console.log("TS 101 162");
        offset = 2;
    }
